...
df = pd.read_csv(
    "C:/Users/toravi21/Desktop/ciencia de dados final/dados/bruto/MICRODADOS_ENEM_2009.csv",
    encoding="latin1",
    sep=";",
    low_memory=False,
    usecols=colunas
...
df.to_csv(
    "C:/Users/toravi21/Desktop/ciencia de dados final/dados/limpo/2009_selecionado.csv",
    encoding="utf-8",
    sep=";",
    index=False
)